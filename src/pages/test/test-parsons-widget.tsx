...
const TestParsonsWidgetPage: NextPage = () => {
  const { setCurrentProblem, userSolution, isCorrect, isLoading } =
    useParsonsContext();
  ...
  return (
    <div className="container mx-auto p-6 max-w-3xl">
      ...
      <div className="bg-white p-6 border rounded shadow mb-6">
        ...
        <p>
          <strong>Solution Lines:</strong> {userSolution.length}
        </p>
        <p>
          <strong>isCorrect:</strong>{' '}
          {isCorrect === null ? 'null' : isCorrect.toString()}
        </p>
        <p>
      ...
      <div className="bg-white p-6 border rounded shadow mb-6">
        ...
        <p className="mb-4">
          Drag and drop the code blocks to create a solution:
        </p>
